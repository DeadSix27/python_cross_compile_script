{
	...
	'configure_options' : '--enable-static --disable-shared --target={bit_name2}-{bit_name_win}-gcc --host={target_host} --build=x86_64-linux-gnu --with-libssh2 --with-ca-fallback --without-winssl --prefix={output_prefix}/curl_git.installed --exec-prefix={output_prefix}/curl_git.installed',
	'depends_on' : (
		'zlib', 'libssh2',
	),
