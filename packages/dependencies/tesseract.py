{
	...
	'env_exports' : {
		'LDFLAGS' : ' -lnettle -llzma -lz -L/home/vm/python_cross_compile_script/workdir/toolchain/x86_64-w64-mingw32/x86_64-w64-mingw32/lib -lxml2 -lz -llzma -liconv -lws2_32 -lbcrypt -lbz2',
