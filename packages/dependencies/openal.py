{
	...
	'configure_options' :
		...
		' -DCMAKE_INSTALL_PREFIX={target_prefix} -DCMAKE_INSTALL_BINDIR={target_prefix}/bin -DCMAKE_INSTALL_DATADIR={target_prefix}/share -DCMAKE_INSTALL_INCLUDEDIR={target_prefix}/include -DCMAKE_INSTALL_LIBDIR={target_prefix}/lib -DCMAKE_FIND_ROOT_PATH='
