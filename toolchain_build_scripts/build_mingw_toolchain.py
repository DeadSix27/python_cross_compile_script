...
SOURCES['gcc'] = {
	...
	'patches' : [
		( 'https://raw.githubusercontent.com/DeadSix27/python_cross_compile_script/master/mingw_build_scripts/patches/0001-gcc_7_1_0_weak_refs_x86_64.patch', 'p1' ),
		#( 'https://raw.githubusercontent.com/DeadSix27/python_cross_compile_script/master/mingw_build_scripts/patches/0140-gcc-7-Enable-std-experimental-filesystem.patch', 'p1' ), #Unable to get this to work.
	],
	'softlink_to_package' : [
		('gmp'  , 'gmp' ),
		('mpfr' , 'mpfr'),
